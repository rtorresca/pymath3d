...
class Transform(object):
    ...
    def canCreateOn(cls, *args):
        ...
        if len(args) == 0:
            ...
            return Orientation.canCreateOn(args[0]) and Vector.canCreateOn(args[1])
        elif len(args) == 4:
            return Orientation.canCreateOn(args[:3]) and Vector.canCreateOn(args[3])
        elif len(args) == 12:
            return Orientation.canCreateOn(args[:9]) and Vector.canCreateOn(args[9:])
        else:
            return False
    ...
    def __createOnSequence(self, args):
        ...
        elif len(args) == 0 or len(args) == 1 and type(args[0]) == types.NoneType:
            self._v = Vector()
            self._o = Orientation()
        else:
            raise self.Error, \
    ...
    def __init__(self, *args):
        if len(args) == 1 and isTransform(args[0]):
            t = args[0]
